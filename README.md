...
- [phpmyadmin/sql-parser](https://github.com/phpmyadmin/sql-parser) ([5.10.3](https://github.com/phpmyadmin/sql-parser/releases/tag/5.10.3), 4 weeks ago) - A validating SQL lexer and parser with a focus on MySQL dialect.
